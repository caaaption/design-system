...
let package = Package(
  ...
  targets: [
    .target(name: "CaaaptionButton", dependencies: [
      "Spinner",
      .product(name: "PreviewSnapshots", package: "swiftui-preview-snapshots"),
    ]),
    .testTarget(name: "CaaaptionButtonTests", dependencies: [
      "CaaaptionButton",
      .product(name: "PreviewSnapshotsTesting", package: "swiftui-preview-snapshots"),
    ]),
    .target(name: "Spinner", dependencies: [
      .product(name: "PreviewSnapshots", package: "swiftui-preview-snapshots"),
    ]),
    .testTarget(name: "SpinnerTests", dependencies: [
      "Spinner",
      .product(name: "PreviewSnapshotsTesting", package: "swiftui-preview-snapshots"),
    ]),
  ]
